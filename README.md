...
Per entrambe le materie, la teoria proviene dai rispettivi riassunti finali e le carte usano esclusivamente le domande elencate in `Domande probabili.md`. Se modifichi i file `.md`, la webapp si aggiorna al successivo caricamento.
